...
<body>
  <div id="Top" class="back-to-top-container">
    <div class="back-to-top-button-wrapper"><a href="#Top" class="button-round w-inline-block"><img src="{{asset('assets/images/arrow-up_1.svg')}}" alt=""></a></div>
  </div>
  ...
  <div class="announcement-bar">
    <div class="container">
      <div class="announcement-bar-row">
        <div>
          <div>This is a dismissible bar to use for cookies, announcements etc.</div>
        </div><img src="{{asset('assets/images/x_1.svg')}}" data-w-id="abca0b61-ff69-78f1-cb9d-ab979838bb10" alt="" class="announcement-bar-dismiss"></div>
    </div>
  </div>
  <script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.4.1.min.220afd743d.js?site=5ee838a686291d0823d5d495" type="text/javascript" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
